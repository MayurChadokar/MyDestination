    ...
    <div className="fixed inset-0 z-[9999] bg-gray-50 overflow-y-auto pb-20 scrollbar-hide">
      ...
      <div className="px-4 py-6 space-y-3 pb-24">
        ...
        <button
          ...
          className="w-full bg-[var(--color-surface)] text-white p-4 rounded-2xl flex items-center justify-between shadow-lg shadow-emerald-900/10 active:scale-[0.99] transition-all mb-4"
        >
