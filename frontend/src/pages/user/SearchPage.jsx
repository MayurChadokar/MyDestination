...
const SearchPage = () => {
    ...
    return (
        <div className="min-h-screen pb-24">
            ...
            {/* Sticky Header */}
            <div className="sticky top-0 z-30 bg-[#f5fcf5]/80 backdrop-blur-md border-b border-gray-100 pb-3 pt-3 px-4 shadow-sm">
                ...
                <div className="relative mb-3">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl focus:ring-1 focus:ring-[var(--color-surface)] focus:border-[var(--color-surface)] outline-none text-sm font-medium text-gray-700 bg-gray-50/50"
                ...
                <div className="flex gap-3">
                    <button
                        ...
                        ${location
                                ? 'bg-[var(--color-surface)]/5 text-[var(--color-surface)] border-[var(--color-surface)]'
                                : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50'}`}
                    >
                        <Navigation size={14} className={location ? "fill-[var(--color-surface)]" : ""} />
                    ...
                    <button
                        ...
                        ${(filters.minPrice || filters.maxPrice || (Array.isArray(filters.type) && filters.type.length > 0 && filters.type !== 'all') || filters.amenities.length > 0)
                                ...
                                : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50'}`}
                    >
                        <Filter size={14} className={(filters.minPrice || filters.maxPrice || (Array.isArray(filters.type) && filters.type.length > 0 && filters.type !== 'all') || filters.amenities.length > 0) ? "fill-[var(--color-surface)]" : ""} />
                        Filters
                    </button>
                </div>
                ...
                {location && (
                    <div className="mt-3 pt-3 border-t border-gray-100 transition-all animate-in fade-in slide-in-from-top-2">
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-xs font-bold text-[var(--color-surface)] bg-[var(--color-surface)]/10 px-2 py-0.5 rounded-full">
                                {filters.radius} km
                            </span>
                        </div>
                        <input
                            ...
                            className="w-full h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-[var(--color-surface)]"
                        />
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        <button
                            ...
                            className="mt-8 text-sm font-bold text-[var(--color-surface)] hover:underline"
                        >
                            Clear all filters
                        </button>
                    </div>
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="flex items-center gap-2">
                                <div className="relative flex-1">
                                    ...
                                    <input
                                        type="number"
                                        placeholder="Min"
                                        className="w-full pl-5 pr-2 py-1.5 border border-gray-200 rounded-lg text-xs font-medium outline-none focus:border-[var(--color-surface)] bg-gray-50"
                                ...
                                {SUITABILITY_OPTIONS.map((opt) => (
                                    <button
                                        ...
                                        ${filters.suitability === opt
                                                ? 'bg-[var(--color-surface)]/10 text-[var(--color-surface)] border-[var(--color-surface)]'
                        ...
                        {location && (
                            <div>
                                <div className="flex justify-between mb-1">
                                    ...
                                    <span className="text-[10px] font-bold text-[var(--color-surface)]">{filters.radius} km</span>
                                </div>
                                <input
                                    type="range"
                                    min="1" max="50"
                                    ...
                                    className="w-full h-1 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-[var(--color-surface)]"
                                />
                            </div>
                        )}
                        ...
                        <div className="pt-2 pb-6">
                            <button
                                ...
                                className="w-full bg-[var(--color-surface)] text-white py-3 rounded-xl font-bold text-sm shadow-lg shadow-[var(--color-surface)]/20 active:scale-95 transition-transform"
                            >
                                Apply Filters
                            </button>
                        </div>
