...
import { getLocalUserToken, persistLocalUserSession, userAuthService } from '../../services/authService';
...
const CONSUMED_SEARCH_NONCE_PREFIX = 'My Desination_consumed_parcel_search_nonce:';
      ...
      try {
        ...
        if (!userToken) {
          ...
          if (loginPayload?.token) {
            ...
            persistLocalUserSession({ token: userToken, user: loginPayload.user || {} });
          }
        }
        if (disposed) return;
