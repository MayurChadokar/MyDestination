...
const FaqItem = ({ question, answer }) => {
    ...
    return (
        <div className="border border-gray-200 rounded-2xl mb-3 bg-white overflow-hidden transition-all hover:border-gray-300">
            ...
            >
                <span className="font-bold text-sm text-[var(--color-textDark)]">{question}</span>
            ...
            <div className="max-w-3xl mx-auto px-4 pt-6">
                ...
                <div className="grid grid-cols-2 gap-3 mb-8">
                    <button
                        ...
                        className="bg-[var(--color-surface)] text-white p-5 rounded-2xl shadow-lg flex flex-col items-center justify-center gap-2 active:scale-95 transition-transform"
                    >
                    ...
                    <a
                        href="tel:9111384535"
                        className="bg-white border border-gray-200 text-[var(--color-textDark)] p-5 rounded-2xl shadow-sm flex flex-col items-center justify-center gap-2 active:scale-95 transition-transform"
                    >
                        <Phone size={24} />
                ...
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-black text-[var(--color-textDark)]">Frequently Asked Questions</h3>
                </div>

                <div>
                    {loading ? (
                        <div className="p-8 flex justify-center">
                            <Loader2 className="animate-spin text-[var(--color-surface)]" />
                        </div>
                    ) : faqs.length === 0 ? (
                ...
                <div className="mt-8 text-center">
                    ...
                    <a href="mailto:partners@rokkooin.com" className="inline-flex items-center gap-2 text-sm font-bold text-[var(--color-surface)] border-b border-[var(--color-surface)]/20 pb-0.5 hover:border-[var(--color-surface)] transition-colors">
