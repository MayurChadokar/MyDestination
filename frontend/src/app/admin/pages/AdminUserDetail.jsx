                ...
                <div className="space-y-3">
                    {transactions && transactions.length > 0 ? (
                        transactions.map((txn, i) => {
                            ...
                            return (
                                <div key={i} className={`flex items-center justify-between p-4 border rounded-2xl hover:bg-gray-50 transition-colors bg-white ${isAdminAdj ? 'border-green-100 bg-green-50/10' : 'border-gray-100'}`}>
                                    <div className="flex items-center gap-4">
                                        <div className={`w-12 h-12 rounded-full flex items-center justify-center shrink-0 border-2 border-white shadow-sm ${isAdminAdj ? 'bg-green-100 text-green-600' :
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <div className="flex items-center gap-2 mt-1">
                                                ...
                                                {isAdminAdj && <span className="text-[8px] font-bold bg-green-100 text-green-700 px-1.5 py-0.5 rounded uppercase">Admin</span>}
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3 text-sm pt-2">
                            <span className={`text-[10px] font-bold uppercase py-1 px-3 rounded-md ${user.role === 'admin' ? 'bg-green-100 text-green-700' :
