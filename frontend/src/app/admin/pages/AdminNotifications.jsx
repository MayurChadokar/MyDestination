                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl border flex flex-col items-center justify-center gap-2 transition-all ${targetAudience === 'partners' ? 'border-green-500 bg-green-50 text-green-700' : 'border-gray-200 hover:border-gray-300'}`}
                    >
                      <Building2 size={20} />
