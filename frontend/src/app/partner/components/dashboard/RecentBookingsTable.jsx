    ...
    <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden shadow-sm">
      <div className="px-5 py-4 border-b border-gray-100 flex justify-between items-center">
        ...
        <button
          ...
          className="text-xs font-semibold text-[var(--color-surface)] flex items-center gap-1 hover:gap-2 transition-all"
        >
      ...
      <div className="hidden md:block overflow-x-auto">
        <table className="w-full text-left text-sm text-gray-500">
          <thead className="bg-[var(--color-surface)]/5 text-gray-700">
            <tr>
            ...
            {bookings.map((booking) => (
              <tr key={booking._id} className="hover:bg-gray-50/50 transition-colors">
                ...
                <td className="px-6 py-4">
                  <button
                    onClick={() => navigate(`/hotel/bookings/${booking._id}`)}
                    className="text-[var(--color-surface)] hover:text-[var(--color-textDark)] font-medium text-xs border border-[var(--color-surface)]/20 px-3 py-1.5 rounded-lg hover:bg-[var(--color-surface)]/5 transition"
                  >
                    Details
                  </button>
                </td>
