                            ...
                            <form onSubmit={handleSendOtp}>
                                ...
                                <div className="flex bg-gray-100 p-1 rounded-xl mb-6">
                                    <button
                                        ...
                                        className={`flex-1 py-3 rounded-lg text-sm font-bold flex items-center justify-center gap-2 transition-all ${signupMethod === 'phone' ? 'bg-white text-sky-700 shadow-sm' : 'text-gray-400 hover:text-gray-600'}`}
                                    >
                                        <Phone size={18} /> Phone
                                    </button>
                                    <button
                                        ...
                                        className={`flex-1 py-3 rounded-lg text-sm font-bold flex items-center justify-center gap-2 transition-all ${signupMethod === 'email' ? 'bg-white text-sky-700 shadow-sm' : 'text-gray-400 hover:text-gray-600'}`}
                                    >
                                        <Mail size={18} /> Email
                                    </button>
                                </div>
