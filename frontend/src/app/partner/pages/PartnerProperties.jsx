        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[var(--color-surface)] text-white text-[11px] font-bold uppercase tracking-wide active:scale-95"
            >
                      ...
                      <div className="mt-2 flex items-center justify-between">
                        ...
                        <div className="flex gap-2 ml-2">
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-teal-50 text-sky-700 text-[10px] font-bold uppercase border border-sky-100"
                          >
                            <Pencil size={11} /> Edit
                          </button>
                          <button
